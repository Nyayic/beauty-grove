                    ...
                    <div class="flex flex-wrap -mx-4">
                        <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                            <a href="/" class="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                                ...
                                <div class="p-4">
                                    <span class="inline-block px-2 py-1 leading-none bg-orange-200 text-orange-800 rounded-full font-semibold uppercase tracking-wide text-xs">Makeup</span>
                                        <h2 class="mt-2 mb-2  font-bold">Sparkles Salon</h2>
                                        <p class="text-sm">We Visually Transform your appearance with your favorite makeup look. Bridal make up services available as well</p>
                                ...
                                <div class="p-4 border-t border-b text-xs text-gray-700">
                                    ...
                                    <span class="flex items-center">
                                        <i class="far fa-address-card fa-fw text-gray-900 mr-2"></i>Book Appointment
                                    </span>        
                                </div>
                        ...
                        <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                            <a href="/" class="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                                ...
                                <div class="p-4">
                                    <span class="inline-block px-2 py-1 leading-none bg-orange-200 text-orange-800 rounded-full font-semibold uppercase tracking-wide text-xs">Nails</span>
                                    <h2 class="mt-2 mb-2  font-bold">The Boss Look </h2>
                        ...
                        <div class="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                            <a href="/" class="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <h2 class="mt-2 mb-2  font-bold">Teo Bridal Salon</h2>
                                    ...
                                    <div class="mt-3 flex items-center">
                                        <span class="text-sm font-semibold">Ugx</span>&nbsp;
                                        <span class="font-bold text-xl">45,000</span>&nbsp;
                                    </div>
                                </div>
                                <div class="p-4 border-t border-b text-xs text-gray-700">
                                    {/* <span class="flex items-center mb-1">
